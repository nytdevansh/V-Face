                    ...
                    {account ? (
                        <div className="relative">
                            <button
                                ...
                                className="flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 hover:border-cyan-500/30 rounded-none text-xs font-mono text-cyan-400 transition-colors group"
                            >
                            ...
                            <AnimatePresence>
                                {showMenu && (
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0, y: -10 }}
                                        className="absolute right-0 mt-2 w-64 bg-[#0B0C15] border border-white/10 shadow-xl overflow-hidden"
                                    >
                        ...
                        <motion.button
                            ...
                            className="relative px-6 py-2 bg-white text-black text-xs font-bold uppercase tracking-widest hover:bg-cyan-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed group overflow-hidden"
                        >
                            {isConnecting ? (
